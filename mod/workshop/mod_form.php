...
class mod_workshop_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $label = get_string('workshopthreesixty', 'workshop');
        $mform->addElement('select', 'workshopthreesixty', $label, $options);
        $mform->addHelpButton('workshopthreesixty', 'workshopthreesixty', 'workshop');
